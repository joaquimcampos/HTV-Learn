...
if __name__ == "__main__" :
    ...
    # parse arguments
    parser = argparse.ArgumentParser(description='gridsearch HTV on the face dataset.')
    parser.add_argument('--log_dir', type=str, help='log directory.')
    parser.add_argument('--lmbda', type=ArgCheck.p_float, default=1e-3, help='')
    parser.add_argument('--num_train', type=str, default=20000, help='')
    parser.add_argument('--seed', type=int, default=10, help='')
    parser.add_argument('--admm_iter', type=ArgCheck.p_int, default=200000, help='')
    ...
    model_name = (f'htv_{params["dataset_name"]}_'
