...
def merge_json_results(args):
    ...
    dictio = {}
    for json_file in [args.json_file1, args.json_file2]:
        # merge with simple_json if no merged.json file seen,
        # otherwise merge with merged.json
    ...
    if 'merged' not in args.json_file2:
        merged_json_file = args.json_file2.split('.json')[0] + '_merged.json'
    else:
        merged_json_file = args.json_file2
